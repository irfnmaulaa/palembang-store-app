...
class CreateCalculationErrorCheckersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('calculation_error_checkers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('calculation_error_checkers');
    }
}
